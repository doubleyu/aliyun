...
public class UploadPartCopySample {
    ...
    private static String sourceBucketName = "mokylin-hive";
    private static String sourceKey = "fyws_yy_MoneyFlow_2016-04-18.txt";
    private static String targetBucketName = "mokylin-log";
    private static String targetKey = "fyws_yy_MoneyFlow_2016-04-18.txt";
